...
if(OPENCV)
  ...
  if(HAVE_LIB_OPENCV)
    ...
    # Search lib for RasPiCam
    if(RASPICAMCV)
      dune_test_lib(raspicamcv raspiCamCvQueryFrame)
      if(DUNE_SYS_HAS_LIB_RASPICAMCV)
        set(DUNE_USING_RASPICAMCV 1 CACHE INTERNAL "libraspicamcv")
      else(DUNE_SYS_HAS_LIB_RASPICAMCV)
        set(DUNE_USING_RASPICAMCV 0 CACHE INTERNAL "libraspicamcv")
        message(SEND_ERROR "RASPICAMCV LIB NOT FOUND")
      endif(DUNE_SYS_HAS_LIB_RASPICAMCV)
    endif(RASPICAMCV)
  ...
  if(RASPICAMCV)
    message(SEND_ERROR "RASPICAMCV DEPENDS OF OPENCV LIBS")
    set(DUNE_USING_RASPICAMCV 0 CACHE INTERNAL "libraspicamcv")
  endif(RASPICAMCV)
endif(OPENCV)
